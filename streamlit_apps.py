...
Original file is located at
    https://colab.research.google.com/drive/1X3PzbcFzsa_ei0FYaRPOEW1nAa8xgUnC
"""
...
with col1:
    if st.sidebar.button('GitHub'):
        st.sidebar.markdown('[Visit my GitHub profile and check the codes](https://github.com/AnkitVerma002)')
with col2:
    if st.sidebar.button('LinkedIn'):
        st.sidebar.markdown('[Visit my LinkedIn profile](https://www.linkedin.com/in/ankit-verma-911256170/)')